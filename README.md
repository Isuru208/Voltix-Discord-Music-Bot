# Voltix — Discord Music & Utility Bot
...
Voltix is a feature-rich Discord bot built with discord.js v14, centered around high-quality music playback via Lavalink (Kazagumo/Shoukaku). It also includes moderation, automod, invite tracking, giveaways, and server utilities. Uses hybrid sharding for scalability and SQLite for persistent storage.
...
```bash
git clone https://github.com/AeroXDevelopment/voltix.git
cd voltix
npm install
```
