        ...
        const row4 = new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
                ...
                .addOptions([
                    ...
                    { label: "High-Fidelity", value: "hifi_but", emoji: client.emoji.check },
                    { label: "Extreme Bass Boost", value: "extremebass_but", emoji: client.emoji.check },
                    { label: "Vocal Booster", value: "vocal_but", emoji: client.emoji.check },
                    { label: "Electro / Phonk", value: "electro_but", emoji: client.emoji.check },
                    { label: "Cinematic Surround", value: "cinematic_but", emoji: client.emoji.check },
